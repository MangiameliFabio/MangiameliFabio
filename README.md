...
You can see this addon in action in the source code of [Crunch Time](https://github.com/MangiameliFabio/Crunch_Time), a game which was created during the [BeansJam 2022](https://itch.io/jam/beansjam-22). All characters where implemented with state machines generated by the plugin. As time is short in a game jam this was a big advatage and shortened the development time for each character.
